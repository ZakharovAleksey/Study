...
class ToDoList {
public:
	ToDoList() : d_curMonthIter(begin(d_daysPerMonth)) {
...
public:
	...
	void aboutCountry(const std::string& country) {
		auto iter = d_CountryCapital.find(country);
